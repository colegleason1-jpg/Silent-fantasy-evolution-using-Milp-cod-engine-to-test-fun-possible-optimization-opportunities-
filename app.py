...
def init_game_state():
    if 'initialized' not in st.session_state:
        ...
        st.session_state.message = "Immersive 3D Fantasy Realm loaded successfully! Find the Devil NPC to get a quest."
        ...
        st.session_state.active_quest = "Explore the realm and find an NPC to get a quest."
