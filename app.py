...
if 'world_data' not in st.session_state:
    with st.spinner("Running SCRCAE optimization..."):
        ...
        st.session_state.message = "World optimized! Swipe to look around."
...
html_template = html_template.replace('__TERRAIN_DATA__', terrain_json)
html_template = html_template.replace('__BIOMES_DATA__', biomes_json)
html_template = html_template.replace('__CREATURES_DATA__', creatures_json)
