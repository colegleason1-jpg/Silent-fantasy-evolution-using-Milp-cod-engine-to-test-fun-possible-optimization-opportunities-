...
with col1:
    ...
    <div style="background: #05050a; border: 1px solid #3a1a1a; border-radius: 6px; padding: 4px; text-align: center; position: relative;">
        <div id="canvas-container" style="width: 100%; height: 340px; border-radius: 4px; overflow: hidden; box-shadow: inset 0 0 20px rgba(0,0,0,0.9); position: relative;">
    ...
    components.html(three_html, height=370, scrolling=False)
